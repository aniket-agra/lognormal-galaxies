...
int main(void)
{
        ...
        cin >> npkt;
        int ncol;
        cout << "Please enter the number of columns of the P(k) file:" << endl;
        cin >> ncol;
        int ncol1, ncol2;
        cout << "Please enter the column number (staring from 1) for k and P(k) of the correlation function file:" << endl;
        cin >> ncol1 >> ncol2;
        double Rs, b, Rs2, b2;
...
// -------------------------------------------------------------------------
        ...
        interpol pk(pkfname, npkt, ncol, ncol1, ncol2, true, true);
                ...
                for (int i1=0;i1<n1;i1++){
                        ...
                        for (int i2=0;i2<cn2;i2++){
                                ...
                                if(real_dof){
                                        ...
                                        if (n<nkmax && n!=0){
                                                pk1d[n] += pk.value(k)*b2*exp(-ksq*Rs2);
                                                nmodes[n] ++;
                                        }
                                }
                        }
